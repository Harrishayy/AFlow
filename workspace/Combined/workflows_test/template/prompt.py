...
MMLU_PROMPT = """You are an expert in multiple fields. Your task is to answer the following multiple-choice question.
First, think step-by-step to analyze the question and the provided options.
After your reasoning, conclude with the single letter of the correct answer.
Please provide your reasoning and then end your response with "The final answer is: <LETTER>".
For example:
